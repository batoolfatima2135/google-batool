...
export default function About() {
  ...
  return (
    <div className="lg:m-6 m-2">
      ...
      <iframe src="https://www.youtube.com/embed/F1dPD94uVtc?si=XD5kW0UOdN7Uhzin" title="Introduction" className="lg:w-full lg:h-96 md:w-full md:h-96" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
      <Faq />
    </div>
  );
}
