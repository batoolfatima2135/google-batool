...
export default function ProjectProvider({
  ...
  initialProjects = [
  {
    ...
    techstack: [techstack[0], techstack[1], techstack[2], techstack[4], techstack[6], techstack[7], techstack[8], techstack[10], techstack[11], techstack[13]],
    tools: [...tools],
    presentation: 'https://www.youtube.com/embed/PDjNdsEdC0w?si=jiM04stNBPZEbdYV',
  },
  {
    id: 8,
    title: 'Budgetly',
    ...
    techstack: [techstack[2], techstack[6], techstack[10], techstack[11], techstack[12], techstack[13]],
    tools: [tools[1], tools[4], tools[5]],
    presentation: 'https://www.youtube.com/embed/m6nn8ZwF2mM?si=t3XiKxXYApRYC5aB',
  },
  {
    id: 7,
    title: 'Recipe App',
