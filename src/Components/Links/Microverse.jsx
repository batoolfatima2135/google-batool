  ...
  return (
    <div>
      ...
      <p className="text-sm  text-gray-600">
        Remote Full-stack Web developement Program, Full time, Computer software
        engineering for international web developers where students learn
        collaboratively with peers around the world.
      </p>
      <div
      ...
      >
        <a href="https://www.microverse.org/" target="_blank" className="my-1">
          <div className="flex my-4 items-center">
            <Image
              ...
              height={50}
            />
            <p className="mx-4 text-2xl font-bold">Microverse</p>
          </div>
        </a>
        ...
        <ul className="list-disc mx-5">
          ...
          <li className="my-4">
            ...
            <br />· Wireframing · Problem Solving · Test-Driven Development ·
            Web Technologies · Bootstrap · Project Management · Tailwind CSS ·
            Cross-functional Team Leadership · React.js · TypeScript · Git ·
            Functional Programming · Computer Science · GitHub · GitHub · Time
            Management · Unit Testing · Methodology · Progressive Web
            Applications · Version Control · Teamwork · Control Systems ·
            Front-End Design · Database Design · Next.js ·JavaScript ·
            Cross-team Collaboration · Redux.js · Interactive Web · Programming
            · Scalable Web Applications · Communication · Web Development
          </li>
        </ul>
      </div>
    </div>
