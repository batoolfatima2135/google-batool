...
export default function Buttons() {
  return (
    <div className="flex mt-4">
      ...
      <a type="button" href={resume} target="_blank" className="mx-3 border rounded border-white  text-xs lg:text-sm hover:border-gray-300 hover:shadow p-2.5">Download Resume</a>
